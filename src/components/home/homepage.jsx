                    ...
                    <form className="d-flex mb-0 mb-lg-0 mx-lg-5 mb-md-3 mx-md-2 mx-2 mb-3 hvr-mbl-btn">
                        <div className="dropdownbtn">
                            ...
                            <div className="dropdownbtn-content">
                                <Link to="/login"> Redirecting</Link>
                                <a href="#">Forward</a>
                                <a href="#" className="border-bottom-0">Ship</a>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div className="row">
                <div className="col-lg-7 col-md-7 col-12">
                    <div className="tollfree-caption">
                        ...
                        <p>Ringoncore has issued its official Toll Free Number service which comes with abundant
            ...
            <div className="row">
                <div className="col-lg-12 col-md-12 col-12">
                    <div className="support-caption">
                        ...
                        <p>This company is committed to providing the best support to all customers. We at Ringoncore,
                            understand that customers' success is company success, which is why company strive to
                            provide the best support possible. When customers need support, Ringoncore is there to
                            provide the best support and assistance in regards to sales, installations, maintenance,
                            customization, and so forth. Ringoncore are committed to providing best support experience
            ...
            <div className="row">
                <div className="col-lg-7 col-md-7 col-12">
                    <div className="tollfree-caption">
                        ...
                        <hr className="title-bdr"/>
                        <p>Ringoncore is a leading provider of telecommunication services. We offer a wide range
                            ...
                            an affordable price. Ringoncore is the best telecommunication service provider in USA
            ...
            <div className="row">
                <div className="col-lg-12 col-12">
                    <div className="calling-caption">
                        ...
                        <p>With Ringoncore call recording features, you can increase your business productivity and
                    ...
                    <div className="row mb-md-0 mb-sm-2">
                        ...
                        <div className="col-lg-12 col-md-6 col-12 mt-4 mt-lg-4 mt-md-0 d-flex justify-content-lg-end justify-content-md-center justify-content-center">
                            <div className="calling-inner-box">
                                ...
                                <p>Ringoncore is one of the customer support company that provides best customer service
                    ...
                    <div className="row flex-md-wrap justify-content-md-center">
                        ...
                        <div className="col-lg-12 col-md-6 col-12 mt-4 d-flex justify-content-lg-end justify-content-md-center justify-content-center">
                            <div className="calling-inner-box">
                                ...
                                <p>Dial by Name attribute by the Ringoncore has been arranged with the Business Phone
                                    service in order to Speedup the dialing process by Ringoncore</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-6 col-12 d-flex justify-content-lg-end justify-content-md-center justify-content-center">
                            <div className="calling-inner-box miscellenour-box">
                                ...
                                <p>The voicemail system is designed for Ringoncore to communicate a recorded audio
...
<footer className="footer-section">
            ...
            <div className="row">
                <div className="col-lg-4 col-md-4 col-12">
                    <div className="footer-logo-caption">
                        <img src="img/footer-logo-white.png" className="d-block img-fluid" alt="" />
                        <p>Ringoncore is a leading provider of telecommunication services.
    ...
    <div className="copyright-section">
        <p>@ringoncore.com All rights reserved</p>
    </div>
